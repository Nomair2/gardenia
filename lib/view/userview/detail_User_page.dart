...
import '../../controller/user_controller/inyourhand_User_controller.dart';

class DetailUserPage extends StatefulWidget {
  final ProductModel plant;

  const DetailUserPage({super.key, required this.plant});
...
class _DetailUserPageState extends State<DetailUserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(InYourhandUserController());
    return Scaffold(
      body: Obx(
        () => Stack(
          children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            !controller.isgift.value
                                ...
                                : const SizedBox(),
                            GetBuilder<InYourhandUserController>(
                                            ...
                                            InkWell(
                                              onTap: () {
                                                controller.showdialog.value =
                                                    false;
                                                controller2.request(
                                                    widget.plant.storeId,
                                                    "personal",
                                                    widget.plant.plantPrice,
                                                    "");
                                              },
                                              child: Container(
                                                padding:
